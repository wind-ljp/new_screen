...
// 切换预览页面
export const CHANGE_PREVIEW_PAGE = 'CHANGE_PREVIEW_PAGE'
export type CHANGE_PREVIEW_PAGE_TYPE = typeof CHANGE_PREVIEW_PAGE
// 修改页面
...
// 上移一层
export const UP_LARGESCREEN_ELEMENT = 'UP_LARGESCREEN_ELEMENT'
export type UP_LARGESCREEN_ELEMENT_TYPE = typeof UP_LARGESCREEN_ELEMENT
// 下移一层
export const DOWN_LARGESCREEN_ELEMENT = 'DOWN_LARGESCREEN_ELEMENT'
export type DOWN_LARGESCREEN_ELEMENT_TYPE = typeof DOWN_LARGESCREEN_ELEMENT
// 置顶
export const TOP_LARGESCREEN_ELEMENT = 'TOP_LARGESCREEN_ELEMENT'
export type TOP_LARGESCREEN_ELEMENT_TYPE = typeof TOP_LARGESCREEN_ELEMENT
// 置底
export const BOTTOM_LARGESCREEN_ELEMENT = 'BOTTOM_LARGESCREEN_ELEMENT'
export type BOTTOM_LARGESCREEN_ELEMENT_TYPE = typeof BOTTOM_LARGESCREEN_ELEMENT
