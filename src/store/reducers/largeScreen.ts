...
export const largeScreen = (
  ...
  switch (action.type) {
    ...
    // TODOo 切换下一张屏
    case CHANGE_PREVIEW_PAGE: {
      copy.pages = action.pages
      copy.currentPage = action.pages[0]
      const temp: any = action.screen
      copy.screen = temp
      return copy;
    }
    ...
    case COPY_LARGESCREEN_ELEMENET: {
      ...
      copy.currentWidget.coordinateValue.left = copy.currentWidget.coordinateValue.left + 100
      copy.currentWidget.coordinateValue.top = copy.currentWidget.coordinateValue.top + 100
      // console.log(copy)
      return {
        ...copy
        // pastPage: [...copy.pastPage, currentPage]
