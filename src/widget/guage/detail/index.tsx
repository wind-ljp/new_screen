 ...
 * @Description: 性情仪表
 * @Author: liaojingping
 * @Date: 2024-06-05 14:39:30
 * @LastEditors: liaojingping
 * @LastEditTime: 2024-07-25 11:19:19
 */
...
const Detail: FC<IBarProps> = ({ options, data, field }) => {
  ...
  return (
    <Charts
      ...
      option={{
        color: [getOption.options.dataItemStyle_color ?? '#03c2fd'],
        series: [
          {
            type: 'gauge',
            data: [
            ...
            details: {
              ...
              formatter: getOption.options.details_formatter_front + '{value}' + getOption.options.details_formatter,
              offset: [
