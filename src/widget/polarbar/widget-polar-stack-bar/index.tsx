 ...
 * @LastEditTime: 2024-07-25 11:23:18
 */
...
const PolarStackBar: FC<IBarProps> = ({ options, data, field }) => {
  ...
  const getOption = useMemo(() => {
    ...
    const { series, xAxisData, legendData } = handleData(currentData)
    return {
      ...configuration,
      legend: {
